...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Jiddisch-latinsk/Seks-tsum-ershtn-mol'"/>
	...
	<parallel_text xml:lang="swe" location="sex-forsta-gangen.html"/></xsl:variable>
