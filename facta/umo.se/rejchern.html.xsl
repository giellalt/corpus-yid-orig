...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Jiddisch-latinsk/Rejchern'"/>
	...
	<parallel_text xml:lang="swe" location="tips-for-battre-sjalvkansla.html"/></xsl:variable>
