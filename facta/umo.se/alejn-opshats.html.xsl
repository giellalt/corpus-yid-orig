...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Jiddisch-latinsk/Alejn-opshats'"/>
	...
	<parallel_text xml:lang="swe" location="sjalvkansla.html"/></xsl:variable>
