...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Jiddisch-latinsk-skrift/Regler-och-rattigheter/Barns-och-foraldrars-rattigheter-i-varden'"/>
    ...
    <xsl:variable name="mainlang" select="'yid'"/>
	...
	<parallel_text xml:lang="swe" location="barns-och-foraldrars-rattigheter-i-varden2.html"/></xsl:variable>
